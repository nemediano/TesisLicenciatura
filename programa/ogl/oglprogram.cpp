...
OGLProgram::OGLProgram() : m_program_ok(false), m_has_geometry(false), m_vertex_shader(0),
		m_fragment_shader(0), m_geometry_shader(0), m_program(0) {
  // Empty constructor to prevent auto generation
}
